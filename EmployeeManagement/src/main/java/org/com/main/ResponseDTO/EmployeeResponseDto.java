...
public class EmployeeResponseDto {
	...
	public String toString() {
		return "EmployeeResponseDto [employeeID=" + employeeID + ", employeeCode=" + employeeCode + ", reportinManager="
				+ reportinManager + ", designation=" + designation + ", employeeStatus=" + employeeStatus
				+ ", employeeName=" + employeeName + ", firstName=" + firstName + ", lastName=" + lastName
				+ ", firstLastName=" + firstLastName + ", gender=" + gender + ", personalEmployeeID="
				+ personalEmployeeID + ", officialEmployeeID=" + officialEmployeeID + ", baseLocation=" + baseLocation
				+ ", ftCount=" + ftCount + ", hrbpRemarks=" + hrbpRemarks + ", linkedin=" + linkedin + ", profileImage="
				+ profileImage + ", middleName=" + middleName + ", hrbpID=" + hrbpID + ", phoneNumber=" + phoneNumber
				+ ", potential=" + potential + ", region=" + region + ", pastExperienceYears=" + pastExperienceYears
